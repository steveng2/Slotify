           ...
           <div id="inputContainer">
              ...
              <form id="registerForm" action="register.php" method="POST">
                   ...
                   <p>
                       ...
                       <input id="email2" name="email2" type="email" placeholder="e.g bart@springfield.com" value="<?php getInputValue('email2') ?>" required>             
                   </p>
             ...
             <div id="loginText">
               ...
               <ul>
                   ...
                   <li>Follow artists to keep up to date with.</li>
               </ul>
           </div>
        </div>
